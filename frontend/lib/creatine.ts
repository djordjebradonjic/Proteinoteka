...
export const CREATINE_COPY = HR
  ? {
      ...
      page: {
        ...
        description:
          "Usporedi cijene kreatina u hrvatskim trgovinama: monohidrat, Creapure®, kapsule i tablete. Cijena po 100 g i ocjena isplativosti za svaki kreatin na jednom mjestu.",
        ...
        lead:
          "Kreatin monohidrat jedan je od rijetkih dodataka prehrani čiji je učinak potvrđen u desecima studija. Isti se proizvod u različitim trgovinama ne prodaje po istoj cijeni, pa za svaki kreatin prikazujemo cijenu po 100 g, cijenu po dozi i ocjenu isplativosti.",
      ...
      product: {
        ...
        descSuffix: "Cijene u hrvatskim trgovinama, cijena po 100 g i ocjena isplativosti.",
        ...
        scoreTitle: "Ocjena isplativosti",
        scoreCounted: "Kapsule, tablete i gumeni bomboni nemaju ocjenu: proizvođači rijetko navode koliko kreatina zapravo ima u pakiranju, pa bi cijena po gramu bila pogađanje. Usporedi ih po cijeni pakiranja i po dozi.",
        scoreMissing: "Ovaj kreatin nema ocjenu jer trgovina ne navodi težinu pakiranja.",
        scoreLink: "Kako računamo ocjenu",
      ...
      guide: {
        ...
        sections: [
          ...
          },
          {
            ...
            p: "Prah je najjeftiniji po gramu kreatina i lako se dozira. Kapsule i tablete praktičnije su za put, ali je gram kreatina u njima obično nekoliko puta skuplji, a mnogi proizvođači ne navode koliko kreatina pakiranje stvarno sadrži. Zato prahove ocjenjujemo, a kapsule, tablete i gumene bombone samo uspoređujemo po cijeni pakiranja i po dozi.",
          },
          {
            h: "Kako računamo ocjenu isplativosti",
            p: "Za prahove usporedimo cijenu po gramu s medijanom hrvatskog tržišta i pretvorimo je u ocjenu od 0 do 10. Ocjena oko 6,7 znači tipičnu cijenu, a iznad 8 izrazito povoljnu. Provjerenim brendovima dopuštamo malo višu cijenu prije nego što ocjena padne. Ukus i pakiranje ne ulaze u ocjenu.",
          },
        ],
        faq: [
          ...
          { q: "Kako Proteinoteka ocjenjuje kreatin?", a: "Cijenu po gramu praha uspoređujemo s medijanom tržišta i pretvaramo u ocjenu od 0 do 10. Kapsule i tablete ne ocjenjujemo jer sadržaj kreatina u pakiranju često nije naveden." },
        ],
      },
    }
  : {
      ...
      page: {
        ...
        description:
          "Uporedi cene kreatina u srpskim prodavnicama: monohidrat, Creapure®, kapsule i tablete. Cena po 100 g i ocena isplativosti za svaki kreatin na jednom mestu.",
      ...
      product: {
        ...
        descSuffix: "Cene u srpskim prodavnicama, cena po 100 g i ocena isplativosti.",
        ...
        scoreTitle: "Ocena isplativosti",
        scoreCounted: "Kapsule, tablete i gumene bombone nemaju ocenu: proizvođači retko navode koliko kreatina zapravo ima u pakovanju, pa bi cena po gramu bila pogađanje. Poredi ih po ceni pakovanja i po dozi.",
        scoreMissing: "Ovaj kreatin nema ocenu jer prodavnica ne navodi težinu pakovanja.",
        scoreLink: "Kako računamo ocenu",
        cheapest: "Najjeftinije",
      ...
      guide: {
        ...
        sections: [
          ...
          {
            h: "Prah, kapsule ili tablete",
            p: "Prah je najjeftiniji po gramu kreatina i lako se dozira. Kapsule i tablete su praktičnije za put, ali je gram kreatina u njima obično nekoliko puta skuplji, a mnogi proizvođači ne navode koliko kreatina pakovanje zaista sadrži. Zato prahove ocenjujemo, a kapsule, tablete i gumene bombone samo poredimo po ceni pakovanja i po dozi.",
          },
          {
            h: "Kako računamo ocenu isplativosti",
            p: "Za prahove uporedimo cenu po gramu sa medijanom srpskog tržišta i pretvorimo je u ocenu od 0 do 10. Ocena oko 6,7 znači tipičnu cenu, a iznad 8 izrazito povoljnu. Proverenim brendovima dozvoljavamo nešto višu cenu pre nego što ocena padne. Ukus i pakovanje ne ulaze u ocenu.",
          },
        ],
        faq: [
          ...
          { q: "Kako Proteinoteka ocenjuje kreatin?", a: "Cenu po gramu praha poredimo sa medijanom tržišta i pretvaramo u ocenu od 0 do 10. Kapsule i tablete ne ocenjujemo jer sadržaj kreatina u pakovanju često nije naveden." },
        ],
      },
    };
