...
export const metadata: Metadata = {
  ...
  description:
    "Da li protein pravi mišiće kao muškarcima? Šta je „ženski protein" i da li vredi? Konkretni odgovori bez marketinga — sa aktuelnim cenama iz srpskih prodavnica.",
