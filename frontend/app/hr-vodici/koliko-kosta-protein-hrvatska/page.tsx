...
const faqItems = [
  ...
  },
  {
    ...
    a: "Cijene se mijenjaju tjedno, pa je teško dati statičan odgovor. Proteinoteka.com.hr prati sve HR webshopove (GymBeam, MyProtein, Polleo Sport, Proteka, Nutrition Shop HR, Proteini.si HR, Proteini Outlet) i uvijek prikazuje aktualne cijene. Koristite sortiranje po Value Score za najbolji omjer.",
  },
  {
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              {[
                ...
                { store: "Proteini Outlet", desc: "Webshop fokusiran na sniženja i outlet cijene proteina, s redovito osvježenom ponudom akcijskih artikala." },
              ].map(({ store, desc }) => (
