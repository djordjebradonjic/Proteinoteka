...
const PAGE_SEO = {
  rs: {
    ...
    keywords: ["whey protein srbija", "najjeftiniji protein srbija", "uporedi cene proteina", "protein cena po gramu", "suplementi srbija cena", "isplativ protein", "pansport proteini cena", "proteini.si cena", "proteinbox cena", "whey izolat srbija", "whey concentrate srbija", "protein kalkulator srbija"],
    canonical: "https://proteinoteka.rs",
    ogLocale: "sr_RS",
    ogTitle: "Proteinoteka – Da li je tvoj protein vredan novca?",
    ogDescription: "Poredimo cene whey proteina, izolata i blend proteina iz svih srpskih prodavnica. Videćeš tačno koliko platiš po gramu proteina i gde je najisplativija kupovina.",
  ...
  hr: {
    ...
    keywords: ["whey protein hrvatska", "najjeftiniji protein hrvatska", "usporedi cijene proteina", "cijena proteina po gramu", "suplementi hrvatska cijena", "isplativ protein", "gymbeam hrvatska", "polleo sport cijena", "myprotein hrvatska", "whey izolat hrvatska", "whey concentrate hrvatska"],
    canonical: "https://proteinoteka.com.hr",
    ogLocale: "hr_HR",
    ogTitle: "Proteinoteka – Je li tvoj protein vrijedan novca?",
    ogDescription: "Uspoređujemo cijene whey proteina, izolata i blend proteina iz najvećih hrvatskih trgovina. Vidjet ćeš točno koliko plaćaš po gramu proteina i gdje je najisplativija kupnja.",
